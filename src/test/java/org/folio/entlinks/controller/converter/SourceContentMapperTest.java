...
public class SourceContentMapperTest {
  ...
  void testConvertToParsedContentCollection() {
    ...
    assertThat(contentCollection.getRecords().size()).isEqualTo(1);
    ...
    assertThat(tag.getSubfields().get(0).get("a")).isEqualTo(content.getFields().get(0).getSubfields().get("a").get(0));
